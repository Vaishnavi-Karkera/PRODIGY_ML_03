...
cat_images, cat_labels = load_images_from_folder('D:/PRODIGY_ML/Prodigy_ML_3/train/cats', label=0)
dog_images, dog_labels = load_images_from_folder('D:/PRODIGY_ML/Prodigy_ML_3/train/dogs', label=1)
